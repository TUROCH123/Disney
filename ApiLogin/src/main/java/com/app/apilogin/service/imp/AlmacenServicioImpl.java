...
import com.app.apilogin.excepciones.AlmacenExcepcion;
import com.app.apilogin.excepciones.FileNotFoundException;
import com.app.apilogin.service.AlmacenServicio;
...
public class AlmacenServicioImpl implements AlmacenServicio{
	...
	public String almacenarArchivo(MultipartFile archivo) {
		logger.info(Constantes.MENSAJE2,"[almacenarArchivo][archivo] ", archivo);
